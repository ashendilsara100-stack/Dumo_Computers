...
export default function Navbar({ setPage, cartCount, currentPage }) {
  ...
  return (
    <>
                  ...
                  <button
                    ...
                    className={`flex items-center gap-2 px-6 py-3 rounded-xl font-black transition-all border-2 ${
                      isActive
                        ...
                        : "bg-black text-white border-white hover:bg-white hover:text-black hover:border-amber-500 hover:scale-105"
                    }`}
                  >
                    <Icon size={18} />
      ...
      {/* Mobile Menu */}
      {mobileMenuOpen && (
        <div className="md:hidden fixed inset-0 z-40 bg-black bg-opacity-95 backdrop-blur-lg">
