...
import SpaceBackground from "../components/SpaceBackground"; // අලුත් Background එක
  ...
  return (
    <div className="min-h-screen bg-black text-white relative overflow-x-hidden">
      ...
      <div className="relative z-10 w-full">
        ...
        <section className="min-h-[90vh] flex items-center px-6 lg:px-12 max-w-7xl mx-auto pt-20">
          <div className="w-full grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="animate-reveal-up">
              ...
              <p className="text-gray-400 text-lg md:text-xl mb-10 italic max-w-lg opacity-0 animate-fade-in [animation-delay:1s] [animation-fill-mode:forwards]">
                Sri Lanka's elite destination for high-end hardware.
              </p>
              <div className="flex flex-col sm:flex-row gap-4 opacity-0 animate-fade-in [animation-delay:1.2s] [animation-fill-mode:forwards]">
            ...
            <div className="hidden lg:flex justify-end relative animate-reveal-right">
        ...
        {/* FEATURED PRODUCTS WITH REVEAL ANIMATION */}
        ...
        {/* CTA SECTION */}
        <section className="px-6 py-20 animate-reveal-up">
      ...
      <style jsx>{`
        ...
        .animate-reveal-right { animation: reveal-right 1.2s cubic-bezier(0.16, 1, 0.3, 1) both; }
        .animate-reveal-left { animation: reveal-left 1.2s cubic-bezier(0.16, 1, 0.3, 1) both; }
