    ...
    <div className="min-h-screen bg-black text-white relative overflow-x-hidden">
      ...
      <div className="relative z-10 w-full">
        ...
        <div className="border rounded-3xl border-white/20 bg-zinc-950/50 backdrop-blur-md py-12 px-6 relative z-20 border-b-2">
          <div className="max-w-[1400px] rounded-3xl border-white/10 mx-auto flex flex-wrap justify-center md:justify-between gap-10 text-[10px] md:text-xs font-black uppercase tracking-[0.2em] text-zinc-400">
