  ...
  return (
    <div className="min-h-screen bg-black text-white relative">
      ...
      <div className="bg-amber-500 py-20 px-6 text-black text-center mx-6 mb-12 rounded-[50px]">
         ...
         <p className="text-xl font-bold mb-8 max-w-2xl mx-auto opacity-80">Our experts are ready to help you choose the best parts for your budget. WhatsApp us for a custom quote.</p>
         <a href="https://wa.me/94742299006" target="_blank" rel="noopener noreferrer">
            <button className="bg-black text-white px-12 py-5 rounded-2xl font-black text-xl hover:scale-110 transition-all uppercase italic">GET A QUOTE NOW</button>
         </a>
      </div>
