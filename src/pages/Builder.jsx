            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-10">
                <div className="lg:col-span-8 space-y-6">
                    {Object.keys(componentLabels).map((cat, index) => {
                        ...
                        return (
                            <div key={cat} style={{ animationDelay: `${index * 0.1}s` }} className={`rounded-[40px] border-2 transition-all duration-500 animate-reveal-up fill-mode-both ${selectedComponents[cat] ? 'border-amber-500/30 bg-zinc-900/40' : 'border-white/5 bg-zinc-900/20'} ${isLocked ? 'opacity-40 grayscale pointer-events-none' : ''}`}>
